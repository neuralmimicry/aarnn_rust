...
export AARNN_APT_UPDATE_ATTEMPTS="${AARNN_APT_UPDATE_ATTEMPTS:-8}"
export AARNN_APT_INSTALL_ATTEMPTS="${AARNN_APT_INSTALL_ATTEMPTS:-5}"
export AARNN_APT_RETRY_DELAY_SEC="${AARNN_APT_RETRY_DELAY_SEC:-8}"
export AARNN_APT_FETCH_RETRIES="${AARNN_APT_FETCH_RETRIES:-8}"
export AARNN_APT_HTTP_TIMEOUT_SEC="${AARNN_APT_HTTP_TIMEOUT_SEC:-45}"
export AARNN_APT_REQUIRED_BINS="${AARNN_APT_REQUIRED_BINS:-cc}"
