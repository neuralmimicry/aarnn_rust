...
./target/release/neuromorphic_demo --orchestrator --brain-id cluster_master --grpc-addr 0.0.0.0:50051 --ui --ipc > orchestrator.log 2>&1 &
...
./target/release/neuromorphic_demo --node --brain-id vision --grpc-addr 0.0.0.0:50052 --ipc > vision.log 2>&1 &
sleep 2
./target/release/neuromorphic_demo --node --brain-id motor --grpc-addr 0.0.0.0:50053 --ipc > motor.log 2>&1 &
